...
class Anxiety {
    ...
    init() {
        ...
        //MUSICS
        let msc1 = AnxietyMovie(title: "1.Weighless (Marconi Union)", description: "", url: "https://www.youtube.com/embed/UfcAVejslrU")
//        let msc2 = AnxietyMovie(title: "2.Electra (Airstream)", description: "", url: "2KlzPHnOgHM")
        let msc3 = AnxietyMovie(title: "2.Mellomaniac – Chill Out Mix (DJ Shah)", description: "", url: "https://www.youtube.com/embed/GPFdwYlZ3DU")
//        let msc4 = AnxietyMovie(title: "4.Watermark (Enya)", description: "", url: "JQ4nJls4Hic")
        let msc5 = AnxietyMovie(title: "3.Strawberry Swing (Coldplay)", description: "", url: "https://www.youtube.com/embed/ZW7yhS8pc7s")

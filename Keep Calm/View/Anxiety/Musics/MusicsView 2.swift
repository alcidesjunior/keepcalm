...
extension MusicsView: ViewCodeProtocol {
    ...
    func setConstraints() {
        ...
        title1.snp.makeConstraints { (make) in
            make.top.equalTo(intro.snp.top).inset(16)
            make.leading.equalTo(containerView.snp.leading).inset(16)
            make.trailing.equalTo(containerView.snp.trailing).inset(16)
        }
        ...
        title2.snp.makeConstraints { (make) in
            make.top.equalTo(videoPlayerView1.snp.top).inset(16)
            make.leading.equalTo(containerView.snp.leading).inset(16)
            make.trailing.equalTo(containerView.snp.trailing).inset(16)
        }
        ...
        title3.snp.makeConstraints { (make) in
            make.top.equalTo(videoPlayerView2.snp.top).inset(16)
            make.leading.equalTo(containerView.snp.leading).inset(16)
            make.trailing.equalTo(containerView.snp.trailing).inset(16)
        }
        ...
        title4.snp.makeConstraints { (make) in
            make.top.equalTo(videoPlayerView3.snp.top).inset(16)
            make.leading.equalTo(containerView.snp.leading).inset(16)
            make.trailing.equalTo(containerView.snp.trailing).inset(16)
        }
        ...
        title5.snp.makeConstraints { (make) in
            make.top.equalTo(videoPlayerView4.snp.top).inset(16)
            make.leading.equalTo(containerView.snp.leading).inset(16)
            make.trailing.equalTo(containerView.snp.trailing).inset(16)
        }
